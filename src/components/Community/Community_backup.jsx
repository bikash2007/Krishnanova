        ...
        <img
          ...
          className={`${size} rounded-full object-cover border-3 ${
            artistic
              ...
              : "border-white/50 shadow-lg ring-2 ring-indigo-100"
          }`}
          onError={(e) => {
...
const SocialPostCard = ({ post, baseUrl, index }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-pink-500/10 rounded-3xl group-hover:from-indigo-500/20 group-hover:via-purple-500/15 group-hover:to-pink-500/20 transition-all duration-500"></div>
      ...
      <motion.div
        ...
        className="absolute -bottom-2 -left-2 w-5 h-5 text-indigo-400 opacity-40"
      >
        <FaFeatherAlt />
      </motion.div>
      ...
      <div className="relative border border-white/40 rounded-3xl shadow-2xl backdrop-blur-sm overflow-hidden">
        ...
        <div className="px-6 pb-4">
          ...
          <div className="relative">
            <FaQuoteLeft className="absolute -top-2 -left-2 text-indigo-200/50 text-xl" />
            <div className="text-gray-700 text-sm leading-relaxed pl-6">
              ...
              {post.content.length > 100 && (
                <button
                  ...
                  className="text-indigo-600 hover:text-indigo-800 font-medium text-sm ml-1 hover:underline"
                >
    ...
    >
      <Link to="/communityblog">
        {post.image ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-indigo-400 via-purple-500 to-pink-500"></div>
        )}
      ...
      <div className="container max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
          <ArtisticStatsCard
            ...
            color="from-indigo-500 via-cyan-500 to-teal-500"
            delay={0}
          />
          <ArtisticStatsCard
        ...
        >
          <div className="flex items-center justify-between mb-12">
            <div>
              <motion.h3
                whileHover={{ scale: 1.02 }}
                className="text-4xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-3"
              >
                Wisdom Chronicles
              </motion.h3>
              <p className="text-gray-600 text-lg">
            ...
            <Link
              to="/communityblog"
              className="hidden md:flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 text-white rounded-full font-bold hover:shadow-2xl transition-all duration-300 hover:scale-105 group"
            >
              <FaBlog />
            ...
            <AnimatePresence>
              {loading ? (
                ...
                <div className="col-span-full text-center py-20">
                  ...
                  <Link
                    to="/communityblog"
                    className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 text-white rounded-full font-bold text-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
                  >
          ...
          {(topPosts.length > 0 || events.length > 0) && (
            ...
            >
              <InteractiveBox className="inline-block p-1 rounded-full bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500">
                <Link
                  to="/communityblog"
